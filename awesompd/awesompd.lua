...
-- Default user options
   ...
   instance.symbol = "♪"
   instance.symbolfont = "Monospace"
   instance.symbolcolor = "white"
...
function awesompd:wrap_output(text)
   --return '<span font="' .. self.font .. '"><span font="sans 11"><span color="#ce2c51">♪</span></span> ' .. text .. ' </span><span font="sans 11"><span color="#ce2c51">♪</span></span>'
   return '<span font="' .. self.symbolfont .. '"><span color="' .. self.symbolcolor .. '">' .. self.symbol .. '</span></span><span font="' .. self.font .. '"> ' .. text .. ' </span><span font="' .. self.symbolfont .. '"><span color="' .. self.symbolcolor .. '">' .. self.symbol .. '</span></span>'
end
